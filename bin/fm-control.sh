...
#              busy, then submits the harness's exit command. When the pane
#              shows a launch dialog it sends no key at all and stops the
#              attributed harness process with SIGTERM instead (below).
